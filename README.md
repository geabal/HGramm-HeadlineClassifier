...
- sentence-transformers : 문장 벡터 임베딩에 사용합니다.
...
# HGramm에서 본문 선출을 하기 전에는 반드시 llm 모델과 mecab 설정이 필요합니다.
...
id_col = 'url'
# HGramm과 LLM으로 본문 영역을 선출합니다.
df_textarea = hg.get_textarea(data, text_col=text_col, id_col=id_col)
```
